<script lang="ts">
    ...
    import { parseAudioMetadata } from '$lib/helpers/metadata';
...
<Card bind:ref {...props}>
    <CardHeader>
        ...
        <CardDescription>
            {description ?? 'Import metadata from audio file'}
        </CardDescription>
    </CardHeader>
    <CardContent>
        <Input type="file" accept="audio/*" oninput={importFromFile} disabled={isLoading || disabled}/>
    </CardContent>
</Card>