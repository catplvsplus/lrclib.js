...
<div class={cn("h-full w-full relative", props.class)}>
    {#if $isBlurAllowed}
        <div class={cn("h-full w-full z-10 absolute top-0 left-0 backdrop-saturate-200 backdrop-blur-[10vh] bg-black/30")} out:fade={{ delay: 500, duration: 500 }} in:fade={{ duration: 500 }}></div>
